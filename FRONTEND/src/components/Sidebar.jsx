...
const Sidebar = ({ chats, activeChat, onSelectChat, onNavigate, darkMode, onToggleDarkMode, pendingRequestsCount = 0, isLoadingChats = false }) => {
  ...
  return (
    <div className="w-full h-full bg-white dark:bg-darkSideBar flex flex-col">
      {/* Header */}
              ...
              {showMenu && (
                <>
                  ...
                  <motion.div
                    ...
                    className="absolute right-0 mt-2 bg-white dark:bg-gray-700 rounded-xl shadow-xl py-2 z-50 w-48 border border-gray-100 dark:border-gray-600"
                  >
                    <button
                      onClick={() => {
                        onNavigate('requests');
